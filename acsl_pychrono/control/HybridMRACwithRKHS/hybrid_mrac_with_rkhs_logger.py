...
from acsl_pychrono.control.HybridMRACwithRKHS.hybrid_mrac_with_rkhs import HybridMRACwithRKHS
from acsl_pychrono.rkhs.workspace_logger import RKHSWorkspaceLogger

class HybridMRACwithRKHSLogger:
  def __init__(self, gains: HybridMRACwithRKHSGains) -> None:
    self.gains = gains
    self.data_list = []
  ...
  def collectData(self, controller: HybridMRACwithRKHS, simulation_time: float):
