...
from acsl_pychrono.control.TwoLayerMRACwithRKHS.two_layer_mrac_with_rkhs import TwoLayerMRACwithRKHS
from acsl_pychrono.rkhs.workspace_logger import RKHSWorkspaceLogger

class TwoLayerMRACwithRKHSLogger:
  def __init__(self, gains: TwoLayerMRACwithRKHSGains) -> None:
    self.gains = gains
    self.data_list = []
  ...
  def collectData(self, controller: TwoLayerMRACwithRKHS, simulation_time: float):
