...
class TwoLayerMRACwithRKHSGains(BaseMRACGains):
  def __init__(self, flight_params: FlightParams):
    ...
    self.number_of_states = 133 + 2 * self.rkhs_theta_size
    ...
    print(f"[INFO] Successfully loaded TwoLayerMRACwithRKHS Gains")
