...
from acsl_pychrono.control.MRACwithRKHS.mrac_with_rkhs import MRACwithRKHS

class MRACwithRKHSLogger:
  def __init__(self, gains: MRACwithRKHSGains) -> None:
    self.gains = gains
    self.data_list = []
    # Length of the array vector that will be exported 
    self.size_DATA = 181

  def collectData(self, controller: MRACwithRKHS, simulation_time: float):
